...
- `visual_form`: choose one: real screenshot, approved screen recording, HTML UI recreation, GPT Image 2 image, logo cutout, comparison card, flow timeline, diagnostic overlay, or kinetic type.
